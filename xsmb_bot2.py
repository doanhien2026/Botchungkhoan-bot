# ============================================================
# 🤖 BOT XSMB — HOÀN CHỈNH V6.0
# ✅ Tự lưu dữ liệu | ✅ Gửi ngay | ✅ Dễ sửa ở đầu file
# ============================================================
import os
import json
import time
...
CHAT_ID = "1030583610"
DATA_FILE = "xsmb_data.json"   # Tự động tạo, không cần tạo thủ công
...
@app.route('/')
def home():
    return "✅ Bot XSMB V6.0 — Đang hoạt động & Lưu dữ liệu tự động", 200
...
def main():
    ...
    if result:
        ...
        if pred:
            ...
            print("⚠️ Chưa đủ dữ liệu (cần ít nhất 10 ngày)")
    else:
